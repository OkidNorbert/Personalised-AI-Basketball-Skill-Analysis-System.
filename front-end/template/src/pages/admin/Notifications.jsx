        ...
        {loading ? (
          ...
          <div className={`rounded-lg overflow-hidden ${
            ...
            {Array.isArray(sortedNotifications) && sortedNotifications.map(notification => (
              <div
                key={notification.id}
                className={`grid grid-cols-[auto,1fr,auto] gap-3 items-center p-3 border-b border-gray-200 dark:border-gray-700 ${
              ...
              <form onSubmit={handleSendNotification} className="space-y-4">
                ...
                <div>
                    ...
                    >
                      ...
                      <option value="babysitters">Babysitters Only</option>
